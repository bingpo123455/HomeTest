package com.young.cases.userCase;

import com.young.config.TestConfig;
import com.young.modle.user.DailyMissionBarCase;
...
public class DailyMissionBarTest {
    ...
    private String getResult(DailyMissionBarCase dailyMissionBarCase) throws IOException {
        ...
        //  httpGet.setHeader("token","eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJleHAiOjE1Nzk0MTc4NDEsInVzZXJJZCI6IjE3NjUwOSIsImd1ZXN0SWQiOiJsYWxhbGFsYWxhbGFsYWxhbGFsYWxhIiwidXVpZCI6IjU0NjY5ODgzMiIsImlhdCI6MTU3NjgyNTg0MX0.VbSBfA9s98FGNXw10dfJcF1LyKwAFd3ZsUBZHwlgHYI");
